...
<html lang="en">
    <head>
        ...
        <title>NSTI CALICUT Courses</title>
    ...
    <body>
        <div class="container-fluid" id="header-container">
            ...
            <section class="container-fluid courses-offered">
                
                    <div class="section-title text-center">
                        <h2><u><b><span>COURSES OFFERED</span></b></u></h2>
                    </div>
                    <div class="about-page">
                        <div class="about-page-content-one">
                            ...
                            <p class="about-page-content">
                                This exclusive institute  facilitates short term training programme and regular 
                                long term training programme in various disciplines. Long term courses are 
                                conducted in levels such as Craftsmen Training Scheme (CTS), Craft Instructor
                                 Training Scheme (CITS) and recently started Advanced Diploma in IT, Networking
                                  and Cloud course also. IT, Networking and Cloud course is very much essential 
                                  in the current scenario due to a lot of demand in software industries where every 
                                  industry is using cloud as base.We are providing Online Admission for following 
                                  courses.
               ...
               <div class="courses">
                <div class="course-page">
                    <a  href="adit.php">
                    <img class="adit-img-course" src="./assets/images/adit.png" alt="adit course logo" /></a>
                    <a class="adit-courses" href="adit.php">
                    <h3><strong>ADVANCED DIPLOMA IN IT, NETWORKING & CLOUD COMPUTING</strong></h3></a>
                    <p class="content-course">
                        ...
                        800 hours. In addition the trainees will pick up employability skills for 160 hours.
                    </p>
                </div><br>
                <div class="course-row ">
                    <a  href="iot.php">
                    <img class="iot-img-course" src="./assets/images/iot.png" alt="iot logo" /></a>
                    <a class="adit-courses" href="iot.php">
                    <h3><strong>IoT TECHNICIAN (SMART HEALTHCARE) </strong></h3></a>
                    <p class="content-course">
