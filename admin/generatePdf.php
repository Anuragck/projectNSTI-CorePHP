<?php
 ...
 //pdf generating code
    ...
    address,10thCertificateNo,10thMarkPercentage,12thCertificateNo,12thMarkPercentage FROM tbl_users");
    ...
    // Title
    $pdf->Cell(630,20,'NSTI Calicut - Students Details For Admission',1,0,'C');
    // Line break
    $pdf->Ln(20);
