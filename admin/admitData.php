...
<script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.23/js/jquery.dataTables.js"></script>
  ...
  <small  class=" text-muted">Admitted Students Details</small></h2>
  <div class="col-md-12 " align="left">
            <a class="btn btn-secondary btn-sm mb-3" href="./index.php" role="button">Go Back</a>
            </div>
  <div class="col-md-12 mt-2" align="right">
            <a class="btn btn-primary btn-sm mb-3" href="./admitPdf.php" role="button">Download All Data</a>
            </div>
   </div>
