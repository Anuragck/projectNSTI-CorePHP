<?php
 ...
 //pdf generating code
    ...
    address,10thCertificateNo,10thMarkPercentage,12thCertificateNo,12thMarkPercentage FROM tbl_admit WHERE  `courseName`='adit'");
    ...
    // Title
    $pdf->Cell(630,20,'NSTI Calicut - ADIT Admitted Students Details',1,0,'C');
    // Line break
    $pdf->Ln(20);
