...
<html lang="en">
  ...
  <small  class=" text-muted">Payment Verification</small></h2>
  <div class="col-md-1 " align="left">
            <a class="btn btn-secondary btn-sm mt-5" href="./index.php" role="button">Go Back</a>
            </div>
            <div class="col-md-12 " align="right">
            <a class=" btn btn-secondary btn-sm mb-3"  href="./certificateVerification.php" role="button" >N e x t</a>
            </div>
...

{
    ...
    $query2="SELECT * FROM tbl_payment_success WHERE id=$id";
    ...
    $query="INSERT INTO tbl_payment_success(id,fullname,username,email,gender,aadharNumber,courseName,dob,category,phoneNumber,
    ...
    <h4 class='alert-heading'>Payment Verified !</h4>
  ...
  if($res){
    $query1="UPDATE tbl_users SET pay_status=1 WHERE id=$id";
