...
<html lang="en">
  ...
  <small  class=" text-muted">I O T Admitted Students Details</small></h2>
  <div class="col-md-12 " align="left">
            <a class="btn btn-secondary btn-sm mb-3" href="./index.php" role="button">Go Back</a>
            </div>
  <div class="col-md-12 mt-2" align="right">
            <a class="btn btn-primary btn-sm mb-3" href="./iotAdmitPdf.php" role="button">Download All Data</a>
            </div>
   </div>
...
<table id="myTable" class="table table-striped table-hover table-success table-responsive">
  ...
  <?php 
  $i=1;
  $query="SELECT * FROM `tbl_admit` WHERE `courseName`='iot'";
