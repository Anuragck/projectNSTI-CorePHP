<?php
 ...
 //pdf generating code
    ...
    address,10thCertificateNo,10thMarkPercentage,12thCertificateNo,12thMarkPercentage FROM tbl_admit WHERE  `courseName`='iot'");
    ...
    // Title
    $pdf->Cell(630,20,'NSTI Calicut - I O T  Admitted Students Details',1,0,'C');
    // Line break
    $pdf->Ln(20);
